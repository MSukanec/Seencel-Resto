...
import { FloorObject, SeatConfig, ChairType } from "./Canvas";
import { Ruler, RotateCcw } from "lucide-react";
import { cn } from "@/lib/utils";

interface BarPropertiesFormProps {
    object: FloorObject;
    onChange: (updates: Partial<FloorObject>) => void;
}

export function BarPropertiesForm({ object, onChange }: BarPropertiesFormProps) {
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-3">
                ...
                <div className="relative flex items-center justify-center p-8 bg-accent/20 rounded-lg">
                    <div className="relative w-32 h-32 bg-amber-500/10 border-2 border-amber-500 rounded-md"></div>
